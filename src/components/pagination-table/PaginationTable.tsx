...
interface PaginationTableProps {
  columns: any;
  data: Person[];
  deleteRows: (rowsIndex: number[]) => void;
}
        ...
        <table className={`${styles["pagination-table__table"]}`}>
                  ...
                  {row.getVisibleCells().map((cell) => {
                    return (
                      <td
                        className={`${
                          styles[
                            `pagination-table__cell--${cell.column.id.replace('_', '-')}`
                          ]
                        }`}
                        key={cell.id}
                      >
          ...
          <tfoot className={`${styles["pagination-table__footer"]}`}>
            <tr>
              ...
              >
                <div
                  className={`${styles["pagination-table__footer--actions"]}`}
                >
                  <p>
                  ...
                  <Button
                    ...
                    color="darkTurquoise"
                    onClick={() => {
                      deleteRows(Object.keys(rowSelection).map(Number));
                      setRowSelection({});
                    }}
                  >
